...
*Defined in [persistance.ts:63](https://github.com/Extream-SaaS/ex-sdk/blob/ccff5d7/src/persistance.ts#L63)*
...
*Defined in [persistance.ts:58](https://github.com/Extream-SaaS/ex-sdk/blob/ccff5d7/src/persistance.ts#L58)*

###  [PersistanceType.Cookie]

• **[PersistanceType.Cookie]**: *[CookiePersistance](cookiepersistance.md)‹›* = new CookiePersistance()

*Defined in [persistance.ts:60](https://github.com/Extream-SaaS/ex-sdk/blob/ccff5d7/src/persistance.ts#L60)*

###  [PersistanceType.None]

• **[PersistanceType.None]**: *null* = null

*Defined in [persistance.ts:59](https://github.com/Extream-SaaS/ex-sdk/blob/ccff5d7/src/persistance.ts#L59)*
