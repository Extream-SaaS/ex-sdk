...
* [PersistenceType](enums/persistencetype.md)
...
* [ItineraryItemFactory](classes/itineraryitemfactory.md)
* [Notices](classes/notices.md)
* [OnlineUsers](classes/onlineusers.md)
* [PersistenceFactory](classes/persistencefactory.md)
...
* [PollConfiguration](interfaces/pollconfiguration.md)
...
* [ItinerarySubItem](globals.md#itinerarysubitem)
...
* [registry](globals.md#const-registry)
...
*Defined in [admin/admin-itinerary.ts:18](https://github.com/Extream-SaaS/ex-sdk/blob/ed34b16/src/admin/admin-itinerary.ts#L18)*
...
*Defined in [admin/admin-itinerary.ts:20](https://github.com/Extream-SaaS/ex-sdk/blob/ed34b16/src/admin/admin-itinerary.ts#L20)*
...
*Defined in [admin/admin-itineraries.ts:6](https://github.com/Extream-SaaS/ex-sdk/blob/ed34b16/src/admin/admin-itineraries.ts#L6)*
...
*Defined in [consumer/event.ts:22](https://github.com/Extream-SaaS/ex-sdk/blob/ed34b16/src/consumer/event.ts#L22)*
...
*Defined in [consumer/itinerary-item/chat.ts:93](https://github.com/Extream-SaaS/ex-sdk/blob/ed34b16/src/consumer/itinerary-item/chat.ts#L93)*
...
*Defined in [admin/admin-itineraries.ts:7](https://github.com/Extream-SaaS/ex-sdk/blob/ed34b16/src/admin/admin-itineraries.ts#L7)*
...
*Defined in [consumer/event.ts:45](https://github.com/Extream-SaaS/ex-sdk/blob/ed34b16/src/consumer/event.ts#L45)*
...
*Defined in [consumer/event.ts:47](https://github.com/Extream-SaaS/ex-sdk/blob/ed34b16/src/consumer/event.ts#L47)*
...
*Defined in [admin/itinerary-item.ts:37](https://github.com/Extream-SaaS/ex-sdk/blob/ed34b16/src/admin/itinerary-item.ts#L37)*

___

###  ItinerarySubItem

Ƭ **ItinerarySubItem**: *[Chat](classes/chat.md) | [Poll](classes/poll.md) | [Rtmp](classes/rtmp.md) | [WebRtc](classes/webrtc.md) | [Itinerary](classes/itinerary.md)*

*Defined in [consumer/itinerary-item/item-factory.ts:17](https://github.com/Extream-SaaS/ex-sdk/blob/ed34b16/src/consumer/itinerary-item/item-factory.ts#L17)*
...
*Defined in [consumer/itinerary-item/chat.ts:46](https://github.com/Extream-SaaS/ex-sdk/blob/ed34b16/src/consumer/itinerary-item/chat.ts#L46)*
...
*Defined in [consumer/itinerary-item/rtmp.ts:31](https://github.com/Extream-SaaS/ex-sdk/blob/ed34b16/src/consumer/itinerary-item/rtmp.ts#L31)*
...
*Defined in [consumer/itinerary-item/webrtc.ts:22](https://github.com/Extream-SaaS/ex-sdk/blob/ed34b16/src/consumer/itinerary-item/webrtc.ts#L22)*
...
*Defined in [consumer/itinerary-item/chat.ts:25](https://github.com/Extream-SaaS/ex-sdk/blob/ed34b16/src/consumer/itinerary-item/chat.ts#L25)*
...
*Defined in [consumer/itinerary-item/chat.ts:132](https://github.com/Extream-SaaS/ex-sdk/blob/ed34b16/src/consumer/itinerary-item/chat.ts#L132)*
...
*Defined in [topic.ts:72](https://github.com/Extream-SaaS/ex-sdk/blob/ed34b16/src/topic.ts#L72)*
...
*Defined in [admin/itinerary-item.ts:48](https://github.com/Extream-SaaS/ex-sdk/blob/ed34b16/src/admin/itinerary-item.ts#L48)*
...
*Defined in [user/persistence.ts:3](https://github.com/Extream-SaaS/ex-sdk/blob/ed34b16/src/user/persistence.ts#L3)*
...
*Defined in [user/persistence.ts:4](https://github.com/Extream-SaaS/ex-sdk/blob/ed34b16/src/user/persistence.ts#L4)*
...
*Defined in [utils/utils.ts:49](https://github.com/Extream-SaaS/ex-sdk/blob/ed34b16/src/utils/utils.ts#L49)*
...
*Defined in [consumer/itinerary-item/item-factory.ts:9](https://github.com/Extream-SaaS/ex-sdk/blob/ed34b16/src/consumer/itinerary-item/item-factory.ts#L9)*

###  [ItineraryType.Chat]

• **[ItineraryType.Chat]**: *[Chat](classes/chat.md)* = Chat

*Defined in [consumer/itinerary-item/item-factory.ts:10](https://github.com/Extream-SaaS/ex-sdk/blob/ed34b16/src/consumer/itinerary-item/item-factory.ts#L10)*

###  [ItineraryType.Itinerary]

• **[ItineraryType.Itinerary]**: *[Itinerary](classes/itinerary.md)* = Itinerary

*Defined in [consumer/itinerary-item/item-factory.ts:14](https://github.com/Extream-SaaS/ex-sdk/blob/ed34b16/src/consumer/itinerary-item/item-factory.ts#L14)*

###  [ItineraryType.Poll]

• **[ItineraryType.Poll]**: *[Poll](classes/poll.md)* = Poll

*Defined in [consumer/itinerary-item/item-factory.ts:11](https://github.com/Extream-SaaS/ex-sdk/blob/ed34b16/src/consumer/itinerary-item/item-factory.ts#L11)*

###  [ItineraryType.Rtmp]

• **[ItineraryType.Rtmp]**: *[Rtmp](classes/rtmp.md)* = Rtmp

*Defined in [consumer/itinerary-item/item-factory.ts:12](https://github.com/Extream-SaaS/ex-sdk/blob/ed34b16/src/consumer/itinerary-item/item-factory.ts#L12)*

###  [ItineraryType.WebRtc]

• **[ItineraryType.WebRtc]**: *[WebRtc](classes/webrtc.md)* = WebRtc

*Defined in [consumer/itinerary-item/item-factory.ts:13](https://github.com/Extream-SaaS/ex-sdk/blob/ed34b16/src/consumer/itinerary-item/item-factory.ts#L13)*
